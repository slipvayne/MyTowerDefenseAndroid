...
public class Torres_2_shot extends Inimigo {
    ...
    protected int velocidade = 6;
    
    protected boolean textureLoaded;
    
    protected float time=0;
    protected boolean firstTimeShot=false;
    protected boolean inimigoEmRange;
  

    public Torres_2_shot(float SPEED, float width, float height, Vector2 position, Rectangle towerRange) {
            ...
            textureBullet =  GameScreen.manager.get("data/tiros/bullet_2.png",Texture.class);
