...
public class Inimigo_3 extends Inimigo {
	
	   private int resistencia = 20; 
	   private float velocidade = 50f;
	   	
        public Inimigo_3(Vector2 position, float width, float height, float rotation) {
        ...
        public void loadTexture(){
        	...
        	TextureInimigo = GameScreen.manager.get("data/inimigos/inimigo_3.png",Texture.class); 
