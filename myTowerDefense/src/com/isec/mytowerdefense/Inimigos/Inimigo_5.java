...
public class Inimigo_5 extends Inimigo {
	
	   private int resistencia = 70; 
	   private float velocidade = 50f;
	   	
        public Inimigo_5(Vector2 position, float width, float height, float rotation) {
        ...
        public void loadTexture(){
        	...
        	TextureInimigo = GameScreen.manager.get("data/inimigos/inimigo_5.png",Texture.class); 
