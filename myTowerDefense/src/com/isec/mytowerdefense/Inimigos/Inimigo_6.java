...
public class Inimigo_6 extends Inimigo {
	
	   private int resistencia = 100; 
	   private float velocidade = 75f;
	   	
        public Inimigo_6(Vector2 position, float width, float height, float rotation) {
        ...
        public void loadTexture(){
        	...
        	TextureInimigo = GameScreen.manager.get("data/inimigos/inimigo_6.png",Texture.class); 
