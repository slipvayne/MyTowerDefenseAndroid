...
public class Inimigo_4 extends Inimigo {
	
	   private int resistencia = 40; 
	   private float velocidade = 65f;
	   	
        public Inimigo_4(Vector2 position, float width, float height, float rotation) {
        ...
        public void loadTexture(){
        	...
        	TextureInimigo = GameScreen.manager.get("data/inimigos/inimigo_4.png",Texture.class); 
