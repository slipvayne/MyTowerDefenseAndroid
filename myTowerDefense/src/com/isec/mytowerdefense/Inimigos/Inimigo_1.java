...
public class Inimigo_1 extends Inimigo {
	
	   private int resistencia = 5; 
	   private float velocidade = 50f;
	   	
        public Inimigo_1(Vector2 position, float width, float height, float rotation) {
        ...
        public void loadTexture(){
        	...
        	TextureInimigo = GameScreen.manager.get("data/inimigos/inimigo_1.png",Texture.class); 
